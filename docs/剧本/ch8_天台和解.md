...
[主角]（无论外面是不是鬼，我都必须在一点前回到房间。违反规则才是最确定的危险。）
[旁白]我深吸一口气，握住门把手，打开了门。
→ 跳转：ch8_mother_ghost_enters
...
参与角色：主角, 我
AI提示：根据玩家此前人格画像与本次“如何回应绝望”的选项，生成一段6～10行剧本编码格式剧情片段。
        输出格式：
        - 允许使用 [旁白]、[主角]、[主角说]、[NPC:“我”]。
        - 允许描写窒息感、卧室黑暗、心跳、沉默等身体与环境反应，但不要生成新选项。
        - 不要生成跳转，片段结束后由固定流程跳转。
        固定事实：
        - “我”不相信仅靠语言能够改变现实，也不会在此处被直接说服。
        - “我”必须把主角的回应反推回主角本人，质问主角是否真的做得到。
        - 主角必须意识到继续争论没有意义，需要用一次实际行动证明“改变”不是空话。
        - 片段必须为后续离开房间、前往天台展示另一种生活感受铺垫。
        - 违规提醒造成的窒息感仍在，但不能在此处停止。
        必说台词：
        ...
        禁止让“我”立即认同主角，禁止停止违规提醒，禁止提前获得碎片或跳过天台段落。
...
[主角说]从小到大，师长们说想要学习好专注非常重要，除了学习的事，啥都是不务正业。唾沫星子快把我淹死。
...
参与角色：主角, 我
AI提示：根据玩家此前人格画像、本章对话方式，以及“是否直接告诉答案”的选择，生成一段6～10行剧本编码格式剧情片段。
        输出格式：
        - 允许使用 [旁白]、[主角]、[主角说]、[NPC:“我”]。
        - 必须包含以旁白角度描写“我”的内心感受：它第一次感到自己不是任务目标、不是需要被矫正的失败品，而是一个被允许自己思考答案的独立个体。
        - 允许描写沉默、风声、栏杆、城市灯光、窒息感减弱等氛围，但不要生成新选项。
        - 不要生成跳转，片段结束后由固定流程跳转。
        固定事实：
        - “我”第一次感到自己作为独立个体被主角尊重，而不是被当作需要完成的副本任务。
        - 这份尊重不是功利哄劝，而是让“我”保留自己理解世界的权利。
        - “我”意识到主角不只是为了活命，也确实想改变一些事情；这已经超过副本任务本身。
        - “我”不会彻底治愈，不会宣布世界美好，也不会永久消失。
        - 片段结尾必须让“我”产生疑问：主角为什么要做这些、为什么要说这么多，为后续固定台词承接。
        动态表现：
        - 选择“……告诉你就没有意义了”：突出主角克制告知的尊重，“我”怔住更久，感受到纯粹的不干涉。
        - 选择“错位”：突出主角承认答案有限，“我”意识到主角没有把个人答案包装成真理。
        ...
        禁止宣布副本结束，禁止给出正式结局，禁止彻底解决“我”的心理困境，禁止提前让警报停止。
