...
# 三张输入图（按处理顺序）
INPUT_FILES = [
    "E:/Happy-Child/client/public/assets/maps/gate/提取图1.png",
    "E:/Happy-Child/client/public/assets/maps/gate/提取图2.png",
    "E:/Happy-Child/client/public/assets/maps/gate/提取图3.png",
]

OUTPUT_DIR = "E:/Happy-Child/client/public/assets/maps/gate/校门物品_sprites"
TARGET_SIZE = 256
MIN_AREA = 150  # 校门场景物品较小，适当降低阈值
